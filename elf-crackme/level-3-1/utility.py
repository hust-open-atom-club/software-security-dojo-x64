...
if __name__ == "__main__":
    print("We have provided a binary with a corrupted PLT table jumping to the GOT table. Please follow the PLT table jump order, use the script, and execute it to obtain the flag.")
    main()
